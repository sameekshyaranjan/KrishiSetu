  ...
  return (
    <div className="space-y-12 sm:space-y-16 py-6 pb-20 overflow-x-hidden">
      ...
      <section className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-4 sm:pt-8">
        ...
        <p className="mt-6 text-base sm:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto font-normal leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6 max-w-xl mx-auto">
          ...
          <Link 
            to="/register/farmer"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white font-semibold text-base shadow-sm hover:shadow-md transition-all group"
          >
          ...
          <Link 
            to="/register/trader"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-amber-500 hover:bg-amber-600 text-slate-950 font-semibold text-base shadow-sm hover:shadow-md transition-all group"
          >
        ...
        <div className="flex items-center justify-center gap-6 pt-5 text-xs font-medium text-muted-foreground">
          <Link 
            to="/mandi-prices" 
        ...
        {/* 2. Realistic Product Hero Mockup Frame */}
        <ProductPreview />
      </section>
      ...
      {/* 4. Enterprise Bento Feature Grid */}
      <BentoFeatures />
