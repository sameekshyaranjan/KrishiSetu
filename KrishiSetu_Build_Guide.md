...
- Install: `react-router-dom`, `axios`, `react-hook-form`, `recharts`, `react-hot-toast`, `lucide-react`.
- Tech: npm
...
- Trader sidebar links: Dashboard, Browse Listings, My Bids, Procurement History, Messages, Profile.
- Tech: React Router, Layout component
